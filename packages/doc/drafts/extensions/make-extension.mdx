...
VulcanSQL provides 17 categories of extension to make you write your customized extension and put the base extension component into [@vulcan-sql/api-layer](./vulcan-sql-core), [@vulcan-sql/build](./vulcan-sql-build), [@vulcan-sql/serve](./vulcan-sql-serve) separately.
...
2. Install VulcanSQL base extension packages.
   ...
   Because base extension components existed in [@vulcan-sql/api-layer](./vulcan-sql-core), [@vulcan-sql/build](./vulcan-sql-build), [@vulcan-sql/serve](./vulcan-sql-serve) separately.

   You could install these 3 packages all or according to which base extension you need to install its package.

   ```base
   my-extension $ npm i @vulcan-sql/api-layer @vulcan-sql/build @vulcan-sql/serve
   ```
...
```js
const { InputValidator } = require('@vulcan-sql/api-layer');
...
```js
import { InputValidator } from '@vulcan-sql/api-layer';
