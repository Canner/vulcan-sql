...
You could use [npm link](https://docs.npmjs.com/cli/v8/commands/npm-link) to link extension package locally or install local extension package by `npm i -g <extension-package-folder>`, you could see [Use your customized extensions
](./customize-extension).
