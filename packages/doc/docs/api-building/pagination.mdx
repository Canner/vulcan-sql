...
VulcanSQL has implemented some pagination strategies for us, we can use them simply by setting the configuration in [API Schema](./configuration/data-api-schema). No SQL modification is required.
