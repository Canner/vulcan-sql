...
After development and testing, time to ship our code to production servers. Vulcan server only needs a few resources to run, to generate these resources, use `vulcan package` command.
